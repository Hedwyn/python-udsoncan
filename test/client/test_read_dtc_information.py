...
class GenericTest_RequestStatusMask_ResponseNumberOfDTC:
    ...
    def _test_normal_behaviour_param_instance(self):
        response = getattr(self.udsclient, self.client_function).__call__(
            Dtc.Status(
                ...
                confirmed=True,
                test_not_completed_since_last_clear=True,
    ...
    def test_normal_behaviour_harmless_extra_byte(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\xfb\x01\x12\x34\x00\x11\x22"
        )
...
class TestReportNumberOfDTCByStatusMask(
    ClientServerTest, GenericTest_RequestStatusMask_ResponseNumberOfDTC
):  # Subfn = 0x1
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestStatusMaskRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0x1, client_function="get_number_of_dtc_by_status_mask"
        )
...
class GenericTestStatusMaskRequest_DtcAndStatusMaskResponse:
    ...
    def client_assert_response(self, response, expect_all_zero_third_dtc=False):
        self.assertEqual(
            response.service_data.status_availability.get_byte_as_int(), 0xFB
        )
        ...
        if expect_all_zero_third_dtc:
            ...
            self.assertEqual(
                response.service_data.dtcs[2].status.get_byte_as_int(), 0x00
            )
            self.assertEqual(
                response.service_data.dtcs[2].severity.get_byte_as_int(), 0x00
            )
    ...
    def test_normal_behaviour(self):
        ...
        self.conn.fromuserqueue.put(
            b"\x59" + self.sb + b"\xfb\x12\x34\x56\x20\x12\x34\x57\x60"
        )
    ...
    def test_dtc_duplicate(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\xfb\x12\x34\x56\x20\x12\x34\x56\x60"
        )

    def _test_dtc_duplicate(self):
        response = getattr(self.udsclient, self.client_function).__call__(0x5A)
        self.assertEqual(
            len(response.service_data.dtcs), 2
        )  # We want both of them. Server should avoid duplicate
    ...
    def _test_normal_behaviour_zeropadding_ok_consider_allzero(self):
        ...
        for i in range(5):
            response = getattr(self.udsclient, self.client_function).__call__(0x5A)
            self.client_assert_response(
                response, expect_all_zero_third_dtc=expect_all_zero_third_dtc_values[i]
            )
    ...
    def _test_normal_behaviour_zeropadding_notok_ignore_allzero_exception(self):
        ...
        for i in range(5):
            if exception_values[i]:
                ...
                self.client_assert_response(
                    response,
                    expect_all_zero_third_dtc=expect_all_zero_third_dtc_values[i],
                )
...
class TestReportDTCByStatusMask(
    ClientServerTest, GenericTestStatusMaskRequest_DtcAndStatusMaskResponse
):  # Subfn = 0x2
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestStatusMaskRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0x2, client_function="get_dtc_by_status_mask"
        )
...
class TestReportDTCSnapshotIdentification(ClientServerTest):  # Subfn = 0x3
    ...
    def test_normal_behaviour(self):
        ...
        self.conn.fromuserqueue.put(
            b"\x59\x03\x12\x34\x56\x01\x12\x34\x56\x02\x78\x9a\xbc\x03"
        )
...
class TestReportDTCSnapshotRecordByDTCNumber(ClientServerTest):  # Subfn = 0x4
    class Codec4711(DidCodec):
        ...
        def decode(self, did_payload):
            ...
            (v["ect"], v["tp"], v["rpm"], v["map"]) = struct.unpack(
                ">BBHB", did_payload
            )
            return v
    ...
    def test_single_snapshot(self):  # Example provided in standard
        ...
        self.conn.fromuserqueue.put(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        )

    def _test_single_snapshot(self):
        response = self.udsclient.get_dtc_snapshot_by_dtc_number(
            dtc=0x123456, record_number=2
        )
    ...
    def _test_single_snapshot_with_instance_param(self):
        response = self.udsclient.get_dtc_snapshot_by_dtc_number(
            dtc=Dtc(0x123456), record_number=2
        )
        self.single_snapshot_assert_response(response)
    ...
    def test_single_snapshot_zeropadding_notok_exception(
        self,
    ):  # Example provided in standard
        data = b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        for i in range(7):
            self.wait_request_and_respond(data + b"\x00" * (i + 1))
    ...
    def _test_single_snapshot_zeropadding_notok_exception(self):
        ...
        for i in range(7):
            with self.assertRaises(InvalidResponseException):
                self.udsclient.get_dtc_snapshot_by_dtc_number(
                    dtc=0x123456, record_number=2
                )

    def test_single_snapshot_zeropadding_notok_no_exception(
        self,
    ):  # Example provided in standard
        data = b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        for i in range(7):
    ...
    def test_single_snapshot_2_did(self):  # Example provided in standard
        ...
        self.assertEqual(request, b"\x19\x04\x12\x34\x56\x02")
        self.conn.fromuserqueue.put(
            b"\x59\x04\x12\x34\x56\x24\x02\x02\x47\x11\xa6\x66\x07\x50\x20\x67\x89\x99\x88\x77"
        )
    ...
    def test_multiple_snapshot_multiple_did(self):
        ...
        self.conn.fromuserqueue.put(
            b"\x59\x04\x12\x34\x56\x24\x02\x02\x47\x11\xa6\x66\x07\x50\x20\x67\x89\x99\x88\x77\x03\x01\x44\x55\x43\x21"
        )

    def _test_multiple_snapshot_multiple_did(self):
        response = self.udsclient.get_dtc_snapshot_by_dtc_number(
            dtc=0x123456, record_number=0xFF
        )
    ...
    def _test_invalid_length_incomplete_dtc_exception(self):
        for i in range(2):
            with self.assertRaises(InvalidResponseException):
                self.udsclient.get_dtc_snapshot_by_dtc_number(
                    dtc=0x123456, record_number=0x02
                )
    ...
    def test_invalid_length_missing_identifier_number_exception(self):
        ...
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03"
        )
    ...
    def invalid_length_missing_did_server_task(self):
        ...
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01"
        )
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01\x67"
        )
    ...
    def invalid_length_missing_data_server_task(self):
        ...
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66"
        )
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07"
        )
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50"
        )
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01\x67\x89"
        )
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01\x67\x89\x99"
        )
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01\x67\x89\x99\x88"
        )
    ...
    def test_bad_subfunction_exception(self):
        self.wait_request_and_respond(
            b"\x59\x05\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def test_bad_dtc_exception(self):
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x57\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def test_bad_record_number_exception(self):
        self.wait_request_and_respond(
            b"\x59\x04\x12\x34\x56\x24\x03\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def _test_oob_values(self):
        ...
        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_snapshot_by_dtc_number(
                dtc=0x1000000, record_number=0x02
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_snapshot_by_dtc_number(
                dtc=0x123456, record_number=-1
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_snapshot_by_dtc_number(
                dtc=0x123456, record_number=0x100
            )
...
class TestReportDTCSnapshotRecordByRecordNumber(ClientServerTest):  # Subfn = 0x5
    ...
    def test_single_snapshot(self):  # Example provided in standard
        ...
        self.conn.fromuserqueue.put(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def test_single_snapshot_2_did(self):  # Example provided in standard
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x02\x47\x11\xa6\x66\x07\x50\x20\x67\x89\x99\x88\x77"
        )
    ...
    def test_multiple_snapshot_multiple_dtc(self):
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x02\x47\x11\xa6\x66\x07\x50\x20\x67\x89\x99\x88\x77\x03\x12\x34\x57\x25\x01\x44\x55\x43\x21"
        )
    ...
    def _test_invalid_length_incomplete_dtc_no_exception(self):
        self.udsclient.config["exception_on_invalid_response"] = False
        for i in range(2):
            response = self.udsclient.get_dtc_snapshot_by_record_number(
                record_number=0x02
            )
            self.assertFalse(response.valid)
    ...
    def invalid_length_missing_identifier_number_server_task(self):
        ...
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x12\x34\x57\x25"
        )
    ...
    def invalid_length_missing_did_server_task(self):
        ...
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x12\x34\x57\x25\x01"
        )
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x12\x34\x57\x25\x01\x67"
        )
    ...
    def invalid_length_missing_data_server_task(self):
        ...
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66"
        )
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07"
        )
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50"
        )
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x12\x34\x57\x25\x01\x67\x89"
        )
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x12\x34\x57\x25\x01\x67\x89\x99"
        )
        self.wait_request_and_respond(
            b"\x59\x05\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x12\x34\x57\x25\x01\x67\x89\x99\x88"
        )
    ...
    def test_bad_subfunction_exception(self):
        self.wait_request_and_respond(
            b"\x59\x06\x02\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def test_bad_record_number_exception(self):
        self.wait_request_and_respond(
            b"\x59\x05\x03\x12\x34\x56\x24\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
...
class GenericReportExtendedDataByRecordNumber:
    ...
    def test_single_data(self):
        ...
        self.conn.fromuserqueue.put(
            b"\x59" + self.sb + b"\x12\x34\x56\x20\x99\x01\x02\x03\x04\x05"
        )

    def _test_single_data(self):
        response = getattr(self.udsclient, self.client_function).__call__(
            dtc=0x123456, record_number=0x99, data_size=5
        )
    ...
    def _test_single_data_instance_param(self):
        response = getattr(self.udsclient, self.client_function).__call__(
            dtc=Dtc(0x123456), record_number=0x99, data_size=5
        )
        self.assert_single_data_response(response)
    ...
    def _test_single_data_config_size(self):
        ...
        response = getattr(self.udsclient, self.client_function).__call__(
            dtc=0x123456, record_number=0x99
        )
        self.assert_single_data_response(response)
    ...
    def test_double_data(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x12\x34\x56\x20\x10\x01\x02\x03\x11\x04\x05\x06"
        )

    def _test_double_data(self):
        response = getattr(self.udsclient, self.client_function).__call__(
            dtc=0x123456, data_size=3
        )
    ...
    def _test_invalid_length_no_response_exception(self):
        for i in range(2):
            with self.assertRaises(InvalidResponseException):
                getattr(self.udsclient, self.client_function).__call__(
                    dtc=0x123456, data_size=3, record_number=0x99
                )
    ...
    def invalid_length_missing_data_server_task(self):
        ...
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x12\x34\x56\x20\x99\x01\x02"
        )
    ...
    def test_wrong_subfn_response_exception(self):
        self.wait_request_and_respond(
            b"\x59" + self.badsb + b"\x12\x34\x56\x20\x99\x01\x02\x03"
        )
    ...
    def test_wrong_record_number_response_exception(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x12\x34\x56\x20\x98\x01\x02\x03"
        )
    ...
    def test_wrong_service_response_exception(self):
        self.wait_request_and_respond(
            b"\x6f" + self.sb + b"\x12\x34\x56\x20\x98\x01\x02\x03"
        )
    ...
    def _test_oob_values(self):
        with self.assertRaises(ValueError):
            getattr(self.udsclient, self.client_function).__call__(
                dtc=-1, data_size=3, record_number=0x99
            )
        with self.assertRaises(ValueError):
            getattr(self.udsclient, self.client_function).__call__(
                dtc=0x1000000, data_size=3, record_number=0x99
            )

        with self.assertRaises(ValueError):
            getattr(self.udsclient, self.client_function).__call__(
                dtc=0x123456, data_size=3, record_number=-1
            )

        with self.assertRaises(ValueError):
            getattr(self.udsclient, self.client_function).__call__(
                dtc=0x123456, data_size=3, record_number=0x100
            )

    def test_oob_values_data_size(self):  # validation is made at interpret_response
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x12\x34\x56\x20\x99\x01\x02\x03"
        )
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x12\x34\x56\x20\x99\x01\x02\x03"
        )
    ...
    def _test_oob_values_data_size(self):
        with self.assertRaises(ValueError):
            getattr(self.udsclient, self.client_function).__call__(
                dtc=0x123456, data_size=-1, record_number=0x99
            )
...
class TestReportDTCExtendedDataRecordByDTCNumber(
    ClientServerTest, GenericReportExtendedDataByRecordNumber
):  # Subfn = 0x6
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericReportExtendedDataByRecordNumber.__init__(
            self,
            subfunction=0x06,
            client_function="get_dtc_extended_data_by_dtc_number",
        )
...
class TestReportNumberOfDTCBySeverityMaskRecord(ClientServerTest):  # Subfn = 0x7
    ...
    def _test_normal_behaviour_param_int(self):
        response = self.udsclient.get_number_of_dtc_by_status_severity_mask(
            status_mask=0x01, severity_mask=0xC0
        )
        self.assertEqual(response.service_data.dtc_format, Dtc.Format.ISO14229_1)
        self.assertEqual(response.service_data.dtc_count, 0x1234)
    ...
    def _test_normal_behaviour_param_instance(self):
        response = self.udsclient.get_number_of_dtc_by_status_severity_mask(
            status_mask=Dtc.Status(test_failed=True),
            severity_mask=Dtc.Severity(check_immediately=True, check_at_next_exit=True),
        )
        self.assertEqual(response.service_data.dtc_format, Dtc.Format.ISO14229_1)
        self.assertEqual(response.service_data.dtc_count, 0x1234)
    ...
    def _test_bad_response_subfn_exception(self):
        with self.assertRaises(UnexpectedResponseException):
            self.udsclient.get_number_of_dtc_by_status_severity_mask(
                status_mask=0x01, severity_mask=0xC0
            )
    ...
    def _test_oob_value(self):
        with self.assertRaises(ValueError):
            self.udsclient.get_number_of_dtc_by_status_severity_mask(
                status_mask=0x100, severity_mask=0xC0
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_number_of_dtc_by_status_severity_mask(
                status_mask=-1, severity_mask=0xC0
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_number_of_dtc_by_status_severity_mask(
                status_mask="a", severity_mask=0xC0
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_number_of_dtc_by_status_severity_mask(
                status_mask=0x01, severity_mask=0x100
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_number_of_dtc_by_status_severity_mask(
                status_mask=0x01, severity_mask=-1
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_number_of_dtc_by_status_severity_mask(
                status_mask=0x01, severity_mask="a"
            )
...
class TestReportDTCBySeverityMaskRecord(ClientServerTest):  # Subfn = 0x8
    ...
    def test_normal_behaviour(self):
        ...
        self.conn.fromuserqueue.put(
            b"\x59\x08\xfb\x80\x99\x12\x34\x56\x20\x40\x88\x12\x34\x57\x60"
        )

    def _test_normal_behaviour(self):
        response = self.udsclient.get_dtc_by_status_severity_mask(
            status_mask=0x01, severity_mask=0xC0
        )
        self.client_assert_response(response)
    ...
    def _test_normal_behaviour_param_instance(self):
        self.udsclient.get_dtc_by_status_severity_mask(
            status_mask=Dtc.Status(test_failed=True),
            severity_mask=Dtc.Severity(check_immediately=True, check_at_next_exit=True),
        )
    ...
    def test_dtc_duplicate(self):
        self.wait_request_and_respond(
            b"\x59\x08\xfb\x80\x99\x12\x34\x56\x20\x40\x88\x12\x34\x56\x60"
        )
    ...
    def _test_normal_behaviour_zeropadding_ok_consider_allzero(self):
        self.udsclient.config["tolerate_zero_padding"] = True
        self.udsclient.config["ignore_all_zero_dtc"] = False
        expect_all_zero_third_dtc_values = [
            False,
            False,
            False,
            False,
    ...
    def _test_oob_value(self):
        ...
        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_by_status_severity_mask(
                status_mask="aaa", severity_mask=0xC0
            )
        ...
        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_by_status_severity_mask(
                status_mask=0x01, severity_mask="aaa"
            )
...
class GenericTestNoParamRequest_DtcAndStatusMaskResponse:
    ...
    def client_assert_response(self, response, expect_all_zero_fourth_dtc=False):
        self.assertEqual(
            response.service_data.status_availability.get_byte_as_int(), 0x7F
        )
        ...
        if expect_all_zero_fourth_dtc:
            ...
            self.assertEqual(
                response.service_data.dtcs[3].status.get_byte_as_int(), 0x00
            )
            self.assertEqual(
                response.service_data.dtcs[3].severity.get_byte_as_int(), 0x00
            )
    ...
    def test_normal_behaviour(self):
        ...
        self.conn.fromuserqueue.put(
            b"\x59" + self.sb + b"\x7f\x12\x34\x56\x24\x23\x45\x05\x00\xab\xcd\x01\x2f"
        )
    ...
    def test_dtc_duplicate(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x7f\x12\x34\x56\x24\x12\x34\x56\x25"
        )
    ...
    def _test_normal_behaviour_zeropadding_ok_ignore_allzero(self):
        ...
        for i in range(5):
            self.client_assert_response(
                self.do_client_request(), expect_all_zero_fourth_dtc=False
            )
    ...
    def _test_normal_behaviour_zeropadding_ok_consider_allzero(self):
        ...
        for i in range(5):
            self.client_assert_response(
                ...
                expect_all_zero_fourth_dtc=expect_all_zero_fourth_dtc_values[i],
            )
...
class TestReportSupportedDTC(
    ClientServerTest, GenericTestNoParamRequest_DtcAndStatusMaskResponse
):  # Subfn =- 0xA
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestNoParamRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0xA, client_function="get_supported_dtc"
        )


class TestReportFirstTestFailedDTC(
    ClientServerTest, GenericTestNoParamRequest_DtcAndStatusMaskResponse
):  # Subfn = 0xB
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestNoParamRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0xB, client_function="get_first_test_failed_dtc"
        )


class TestReportFirstConfirmedDTC(
    ClientServerTest, GenericTestNoParamRequest_DtcAndStatusMaskResponse
):  # Subfn = 0xC
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestNoParamRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0xC, client_function="get_first_confirmed_dtc"
        )


class TestReportMostRecentTestFailedDTC(
    ClientServerTest, GenericTestNoParamRequest_DtcAndStatusMaskResponse
):  # Subfn = 0xD
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestNoParamRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0xD, client_function="get_most_recent_test_failed_dtc"
        )


class TestReportMostRecentConfirmedDTC(
    ClientServerTest, GenericTestNoParamRequest_DtcAndStatusMaskResponse
):  # Subfn = 0xE
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestNoParamRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0xE, client_function="get_most_recent_confirmed_dtc"
        )


class TestReportMirrorMemoryDTCByStatusMask(
    ClientServerTest, GenericTestStatusMaskRequest_DtcAndStatusMaskResponse
):  # Subfn = 0xF
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestStatusMaskRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0xF, client_function="get_mirrormemory_dtc_by_status_mask"
        )


class TestReportMirrorMemoryDTCExtendedDataRecordByDTCNumber(
    ClientServerTest, GenericReportExtendedDataByRecordNumber
):  # Subfn = 0x10
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericReportExtendedDataByRecordNumber.__init__(
            self,
            subfunction=0x10,
            client_function="get_mirrormemory_dtc_extended_data_by_dtc_number",
        )


class TestReportNumberOfMirrorMemoryDTCByStatusMask(
    ClientServerTest, GenericTest_RequestStatusMask_ResponseNumberOfDTC
):  # Subfn = 0x11
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestStatusMaskRequest_DtcAndStatusMaskResponse.__init__(
            self,
            subfunction=0x11,
            client_function="get_mirrormemory_number_of_dtc_by_status_mask",
        )


class TestReportNumberOfEmissionsRelatedOBDDTCByStatusMask(
    ClientServerTest, GenericTest_RequestStatusMask_ResponseNumberOfDTC
):  # Subfn = 0x12
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestStatusMaskRequest_DtcAndStatusMaskResponse.__init__(
            self,
            subfunction=0x12,
            client_function="get_number_of_emission_dtc_by_status_mask",
        )


class TestReportEmissionsRelatedOBDDTCByStatusMask(
    ClientServerTest, GenericTestStatusMaskRequest_DtcAndStatusMaskResponse
):  # Subfn = 0x13
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestStatusMaskRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0x13, client_function="get_emission_dtc_by_status_mask"
        )
...
class TestReportDTCFaultDetectionCounter(ClientServerTest):  # Subfn = 0x14
    ...
    def _test_normal_behaviour_zeropadding_ok_ignore_allzero(self):
        ...
        for i in range(5):
            self.client_assert_response(
                self.do_client_request(), expect_all_zero_third_dtc=False
            )
    ...
    def _test_normal_behaviour_zeropadding_notok_ignore_allzero_exception(self):
        ...
        for i in range(5):
            if must_return_invalid[i]:
                ...
                self.client_assert_response(
                    self.do_client_request(),
                    expect_all_zero_third_dtc=expect_all_zero_fourth_dtc_values[i],
                )
...
class TestReportDTCWithPermanentStatus(
    ClientServerTest, GenericTestNoParamRequest_DtcAndStatusMaskResponse
):  # Subfn = 0x15
    def __init__(self, *args, **kwargs):
        ClientServerTest.__init__(self, *args, **kwargs)
        GenericTestNoParamRequest_DtcAndStatusMaskResponse.__init__(
            self, subfunction=0x15, client_function="get_dtc_with_permanent_status"
        )
...
class TestreportDTCExtDataRecordByRecordNumber(ClientServerTest):  # Subfn = 0x16
    ...
    def test_single_data(self):
        for i in range(3):
            ...
            self.conn.fromuserqueue.put(
                b"\x59" + self.sb + b"\x33\x12\x34\x56\x20\x01\x02\x03\x04\x05"
            )

    def _test_single_data(self):
        response = self.udsclient.get_dtc_extended_data_by_record_number(
            record_number=0x33, data_size=5
        )
        self.assert_single_data_response(response)

        response = self.udsclient.get_dtc_extended_data_by_record_number(
            record_number=0x33, data_size={0x123456: 5}
        )
        self.assert_single_data_response(response)
    ...
    def _test_single_data_missing_size(self):
        with self.assertRaises(ConfigError):
            self.udsclient.get_dtc_extended_data_by_record_number(
                record_number=0x33, data_size={0x111111: 5}
            )  # 123456 is not there!

        with self.assertRaises(ConfigError):
            self.udsclient.config["extended_data_size"] = {
                0x111111: 5
            }  # 123456 is not there!
    ...
    def test_double_data(self):
        self.wait_request_and_respond(
            b"\x59"
            + self.sb
            + b"\x33\x12\x34\x56\x20\x01\x02\x03\x04\x05\x78\x9a\xbc\x30\xaa\xbb\xcc"
        )

    def _test_double_data(self):
        response = self.udsclient.get_dtc_extended_data_by_record_number(
            record_number=0x33, data_size={0x123456: 5, 0x789ABC: 3}
        )
    ...
    def _test_zero_sized_data(self):
        response = self.udsclient.get_dtc_extended_data_by_record_number(
            record_number=0x33, data_size={0x123456: 0}
        )
    ...
    def invalid_length_missing_data_server_task(self):
        ...
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x33\x12\x34\x56\x20\x01\x02"
        )
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x33\x12\x34\x56\x20\x01\x02\x03"
        )
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x33\x12\x34\x56\x20\x01\x02\x03\x04"
        )
    ...
    def test_wrong_subfn_response_exception(self):
        self.wait_request_and_respond(
            b"\x59" + self.badsb + b"\x33\x12\x34\x56\x20\x01\x02\x03\x04\x05"
        )
    ...
    def test_wrong_record_number_response_exception(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x34\x12\x34\x56\x20\x01\x02\x03\x04\x05"
        )
    ...
    def test_duplicate_dtc(self):
        self.wait_request_and_respond(
            b"\x59"
            + self.sb
            + b"\x33\x12\x34\x56\x20\x01\x02\x03\x04\x05\x12\x34\x56\x20\x01\x02\x03\x04\x05"
        )
    ...
    def test_wrong_service_response_exception(self):
        self.wait_request_and_respond(
            b"\x6f" + self.sb + b"\x33\x12\x34\x56\x20\x01\x02\x03\x04\x05"
        )
    ...
    def _test_oob_values(self):
        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_extended_data_by_record_number(
                record_number=-1, data_size=5
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_extended_data_by_record_number(
                record_number=0xF0, data_size=5
            )  # Limited to 0xEF

        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_extended_data_by_record_number(
                record_number="asd", data_size=5
            )
    ...
    def _test_oob_values_data_size(self):
        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_extended_data_by_record_number(
                record_number=0x33, data_size=-1
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_dtc_extended_data_by_record_number(
                record_number=0x33, data_size={0x123456: -1}
            )
...
class TestReportUserDefMemoryDTCByStatusMask(ClientServerTest):  # Subfn = 0x17
    ...
    def test_normal_behaviour(self):
        ...
        self.conn.fromuserqueue.put(
            b"\x59" + self.sb + b"\x99\xfb\x12\x34\x56\x20\x12\x34\x57\x60"
        )
    ...
    def test_dtc_duplicate(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x99\xfb\x12\x34\x56\x20\x12\x34\x56\x60"
        )
    ...
    def _test_normal_behaviour_zeropadding_ok_ignore_allzero(self):
        ...
        for i in range(5):
            response = self.udsclient.get_user_defined_memory_dtc_by_status_mask(
                0x5A, 0x99
            )
            self.client_assert_response(response, expect_all_zero_third_dtc=False)
    ...
    def _test_normal_behaviour_zeropadding_notok_ignore_allzero_exception(self):
        ...
        for i in range(5):
            if exception_values[i]:
                with self.assertRaises(InvalidResponseException):
                    self.udsclient.get_user_defined_memory_dtc_by_status_mask(
                        0x5A, 0x99
                    )
            else:
                response = self.udsclient.get_user_defined_memory_dtc_by_status_mask(
...
class TestReportUserDefMemoryDTCSnapshotRecordByDTCNumber(
    ClientServerTest
):  # Subfn = 0x18
    class Codec4711(DidCodec):
        def encode(self, did_value):
    ...
    def test_single_snapshot(self):  # Example provided in standard
        request = self.conn.touserqueue.get(timeout=0.2)
        self.assertEqual(request, b"\x19\x18\x12\x34\x56\x02\x99")
        self.conn.fromuserqueue.put(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        )

    def _test_single_snapshot(self):
        response = self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
            dtc=0x123456, record_number=2, memory_selection=0x99
        )
        self.single_snapshot_assert_response(response)
    ...
    def _test_single_snapshot_with_instance_param(self):
        response = self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
            dtc=Dtc(0x123456), record_number=2, memory_selection=0x99
        )
        self.single_snapshot_assert_response(response)

    def test_single_snapshot_zeropadding_ok(self):  # Example provided in standard
        data = b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        self.udsclient.config["tolerate_zero_padding"] = True
        for i in range(7):
            self.wait_request_and_respond(data + b"\x00" * (i + 1))
    ...
    def _test_single_snapshot_zeropadding_notok_exception(self):
        ...
        for i in range(7):
            with self.assertRaises(InvalidResponseException):
                self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                    dtc=0x123456, record_number=2, memory_selection=0x99
                )
    ...
    def test_single_snapshot_2_did(self):  # Example provided in standard
        ...
        self.assertEqual(request, b"\x19\x18\x12\x34\x56\x02\x99")
        self.conn.fromuserqueue.put(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x02\x47\x11\xa6\x66\x07\x50\x20\x67\x89\x99\x88\x77"
        )
    ...
    def test_multiple_snapshot_multiple_did(self):
        request = self.conn.touserqueue.get(timeout=0.2)
        self.assertEqual(request, b"\x19\x18\x12\x34\x56\xff\x99")
        self.conn.fromuserqueue.put(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x02\x47\x11\xa6\x66\x07\x50\x20\x67\x89\x99\x88\x77\x03\x01\x44\x55\x43\x21"
        )

    def _test_multiple_snapshot_multiple_did(self):
        response = self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
            dtc=0x123456, record_number=0xFF, memory_selection=0x99
        )
    ...
    def test_invalid_length_incomplete_dtc_exception(self):
        self.wait_request_and_respond(b"\x59\x18\x99\x12")
        self.wait_request_and_respond(b"\x59\x18\x99\x12\x34")

    def _test_invalid_length_incomplete_dtc_exception(self):
        for i in range(2):
            with self.assertRaises(InvalidResponseException):
                self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                    dtc=0x123456, record_number=0x02, memory_selection=0x99
                )
    ...
    def test_invalid_length_missing_status_exception(self):
        self.wait_request_and_respond(b"\x59\x18\x99\x12\x34\x56")
    ...
    def test_invalid_length_missing_identifier_number_exception(self):
        self.wait_request_and_respond(b"\x59\x18\x99\x12\x34\x56\x24\x02")
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03"
        )
    ...
    def invalid_length_missing_did_server_task(self):
        self.wait_request_and_respond(b"\x59\x18\x99\x12\x34\x56\x24\x02")
        self.wait_request_and_respond(b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47")
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01"
        )
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01\x67"
        )
    ...
    def invalid_length_missing_data_server_task(self):
        self.wait_request_and_respond(b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47")
        self.wait_request_and_respond(b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11")
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6"
        )
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66"
        )
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07"
        )
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50"
        )
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01\x67\x89"
        )
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01\x67\x89\x99"
        )
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20\x03\x01\x67\x89\x99\x88"
        )
    ...
    def test_bad_subfunction_exception(self):
        self.wait_request_and_respond(
            b"\x59\x19\x99\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def test_bad_memory_selection_echo_exception(self):
        self.wait_request_and_respond(
            b"\x59\x18\x98\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        )

    def _test_bad_memory_selection_echo_exception(self):
        with self.assertRaises(UnexpectedResponseException):
            self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                dtc=0x123456, record_number=0x02, memory_selection=0x99
            )
    ...
    def test_bad_memory_selection_echo_no_exception(self):
        self.wait_request_and_respond(
            b"\x59\x19\x98\x12\x34\x56\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def test_bad_dtc_exception(self):
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x57\x24\x02\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def test_bad_record_number_exception(self):
        self.wait_request_and_respond(
            b"\x59\x18\x99\x12\x34\x56\x24\x03\x01\x47\x11\xa6\x66\x07\x50\x20"
        )
    ...
    def test_no_record(self):
        self.wait_request_and_respond(b"\x59\x18\x99\x12\x34\x56\x24")
    ...
    def test_no_record_zero_padding_ok(self):
        data = b"\x59\x18\x99\x12\x34\x56\x24"
        for i in range(8):
            self.wait_request_and_respond(data + b"\x00" * (i + 1))
    ...
    def test_no_record_zero_padding_not_ok_exception(self):
        data = b"\x59\x18\x19\x12\x34\x56\x24"
        for i in range(8):
            self.wait_request_and_respond(data + b"\x00" * (i + 1))
    ...
    def _test_oob_values(self):
        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                dtc=-1, record_number=0x02, memory_selection=0x99
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                dtc=0x1000000, record_number=0x02, memory_selection=0x99
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                dtc=0x123456, record_number=-1, memory_selection=0x99
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                dtc=0x123456, record_number=0x100, memory_selection=0x99
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                dtc=0x123456, record_number=0x02, memory_selection=-1
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_snapshot_by_dtc_number(
                dtc=0x123456, record_number=0x02, memory_selection=0x100
            )
...
class TestTeportUserDefMemoryDTCExtDataRecordByDTCNumber(
    ClientServerTest
):  # Subfn = 0x19
    ...
    def test_single_data(self):
        ...
        self.conn.fromuserqueue.put(
            b"\x59" + self.sb + b"\x88\x12\x34\x56\x20\x99\x01\x02\x03\x04\x05"
        )

    def _test_single_data(self):
        response = self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
            dtc=0x123456, record_number=0x99, data_size=5, memory_selection=0x88
        )
        self.assert_single_data_response(response)
    ...
    def _test_single_data_instance_param(self):
        response = self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
            dtc=Dtc(0x123456), record_number=0x99, data_size=5, memory_selection=0x88
        )
        self.assert_single_data_response(response)
    ...
    def _test_single_data_config_size(self):
        self.udsclient.config["extended_data_size"] = {0x123456: 5}
        response = self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
            dtc=0x123456, record_number=0x99, memory_selection=0x88
        )
        self.assert_single_data_response(response)
    ...
    def _test_single_data_zeropadding_notok_exception(self):
        ...
        for i in range(8):
            with self.assertRaises(InvalidResponseException):
                self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                    dtc=0x123456, record_number=0x99, data_size=5, memory_selection=0x88
                )
    ...
    def test_double_data(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x88\x12\x34\x56\x20\x10\x01\x02\x03\x11\x04\x05\x06"
        )

    def _test_double_data(self):
        response = self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
            dtc=0x123456, data_size=3, memory_selection=0x88
        )
    ...
    def _test_invalid_length_no_response_exception(self):
        for i in range(2):
            with self.assertRaises(InvalidResponseException):
                self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                    dtc=0x123456, data_size=3, record_number=0x99, memory_selection=0x88
                )
    ...
    def invalid_length_missing_data_server_task(self):
        ...
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x88\x12\x34\x56\x20\x99\x01"
        )
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x88\x12\x34\x56\x20\x99\x01\x02"
        )
    ...
    def test_wrong_subfn_response_exception(self):
        self.wait_request_and_respond(
            b"\x59" + self.badsb + b"\x88\x12\x34\x56\x20\x99\x01\x02\x03"
        )
    ...
    def test_wrong_memory_selection_response_exception(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x89\x12\x34\x56\x20\x99\x01\x02\x03"
        )
    ...
    def test_wrong_record_number_response_exception(self):
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x88\x12\x34\x56\x20\x98\x01\x02\x03"
        )
    ...
    def test_wrong_service_response_exception(self):
        self.wait_request_and_respond(
            b"\x6f" + self.sb + b"\x88\x12\x34\x56\x20\x98\x01\x02\x03"
        )
    ...
    def _test_oob_values(self):
        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                dtc=-1, data_size=3, record_number=0x99, memory_selection=0x88
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                dtc=0x1000000, data_size=3, record_number=0x99, memory_selection=0x88
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                dtc=0x123456, data_size=3, record_number=-1, memory_selection=0x88
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                dtc=0x123456, data_size=3, record_number=0x100, memory_selection=0x88
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                dtc=0x123456, data_size=3, record_number=0x99, memory_selection=-1
            )

        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                dtc=0x123456, data_size=3, record_number=0x99, memory_selection=0x100
            )
    ...
    def test_oob_values_data_size(self):  # validation is made at interpret_response
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x88\x12\x34\x56\x20\x99\x01\x02\x03"
        )
        self.wait_request_and_respond(
            b"\x59" + self.sb + b"\x88\x12\x34\x56\x20\x99\x01\x02\x03"
        )
    ...
    def _test_oob_values_data_size(self):
        with self.assertRaises(ValueError):
            self.udsclient.get_user_defined_dtc_extended_data_by_dtc_number(
                dtc=0x123456, data_size=-1, record_number=0x99, memory_selection=0x88
            )
