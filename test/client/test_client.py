...
class TestClient(ClientServerTest):
    ...
    def _test_timeout_override(self):
        ...
        try:
            ...
            self.assertGreater(
                diff,
                timeout,
                "Timeout raised after %.3f seconds when it should be %.3f sec"
                % (diff, timeout),
            )
    ...
    def _test_no_response_overall_timeout(self):
        ...
        self.udsclient.set_configs(
            {"request_timeout": timeout, "p2_timeout": 2, "p2_star_timeout": 2}
        )
    ...
    def _test_no_response_p2_timeout(self):
        ...
        self.udsclient.set_configs(
            {"request_timeout": 2, "p2_timeout": timeout, "p2_star_timeout": 2}
        )
    ...
    def _test_overall_timeout_pending_response(self):
        ...
        try:
            ...
            self.assertIsNotNone(
                self.udsclient.last_response,
                "Client never received the PendingResponse message",
            )
    ...
    def _test_p2_star_timeout(self):
        ...
        self.udsclient.set_configs(
            {"request_timeout": 5, "p2_timeout": 0.5, "p2_star_timeout": timeout}
        )
    ...
    def RCRRP_responses_check(self, respect_overall_timeout):
        ...
        if not respect_overall_timeout:
            self.assertEqual(
                self.udsclient.last_response.code,
                Response.Code.PositiveResponse,
                "Client never received the Positive Response",
            )
    ...
    def _test_p2_star_timeout_overrided_by_diagnostic_session_control(self):
        ...
        self.udsclient.set_configs(
            {"request_timeout": 5, "p2_timeout": 0.5, "p2_star_timeout": 1}
        )
