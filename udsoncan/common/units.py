...
class Units:
    ...
    class Prefixs:
        class Prefix:
            ...
            def __init__(
                self, id: int, name: str, symbol: str, description: Optional[str] = None
            ):
                self.name = name
                self.id = id
                self.symbol = symbol
            ...
            def __repr__(self) -> str:
                desc = (
                    "(%s) " % self.description if self.description is not None else ""
                )
                return "<UDS Unit prefix : %s[%s] %swith ID=%d at %08x>" % (
                    self.name,
                    self.symbol,
                    desc,
                    self.id,
    ...
    class Unit:
        ...
        def __repr__(self):
            desc = (
                "(unit of %s) " % self.description
                if self.description is not None
                else ""
            )
            return "<UDS Unit : %s[%s] %swith ID=%d at %08x>" % (
                self.name,
                self.symbol,
                desc,
                self.id,
    ...
    english_mile = Unit(
        id=0x05, name="mile (English)", symbol="mi", description="length"
    )
    ...
    siemens = Unit(
        id=0x13, name="siemens", symbol="S", description="electric conductance"
    )
    ...
    kelvin = Unit(
        id=0x16, name="kelvin", symbol="K", description="thermodynamic temperature"
    )
    Celsius = Unit(
        id=0x17, name="Celsius", symbol="°C", description="thermodynamic temperature"
    )
    Fahrenheit = Unit(
        id=0x18, name="Fahrenheit", symbol="°F", description="thermodynamic temperature"
    )
    candela = Unit(
        id=0x19, name="candela", symbol="cd", description="luminous intensity"
    )
    ...
    horse = Unit(
        id=0x23, name="horse power(UK and US)", symbol="hp", description="power"
    )
    ...
    meter_per_sec = Unit(
        id=0x2F, name="meter per seconds", symbol="m/s", description="speed"
    )
    ...
    mg_per_stroke = Unit(
        id=0x36,
        name="milligram per stroke",
        symbol="mg/stroke",
        description="mass per engine stroke",
    )
    meter_per_sec2 = Unit(
        id=0x37,
        name="meter per square seconds",
        symbol="m/s2",
        description="acceleration",
    )
    Nm = Unit(id=0x38, name="Newton meter", symbol="Nm", description="moment")
    liter_per_min = Unit(
        id=0x39, name="liter per minute", symbol="l/min", description="flow"
    )
    watt_per_meter2 = Unit(
        id=0x3A, name="watt per square meter", symbol="W/m2", description="intensity"
    )
    bar_per_sec = Unit(
        id=0x3B, name="bar per second", symbol="bar/s", description="pressure change"
    )
    radians_per_sec = Unit(
        id=0x3C,
    ...
    radians = Unit(
        id=0x3D,
        name="radians square second",
        symbol="rad/s2",
        description="angular acceleration",
    )
    kilogram_per_meter2 = Unit(
        id=0x3E, name="kilogram per square meter", symbol="kg/m2", description="-"
    )
    ...
    time1 = Unit(
        id=0x54, name="Time1", symbol="-", description="UTC Hour/Minute/Second"
    )
    ...
    datetime1 = Unit(
        ...
        name="DateAndTime1",
        symbol="-",
        description="Second/Minute/Hour/Day/Month/Year",
    )
    datetime2 = Unit(
        id=0x57,
        name="DateAndTime2",
        symbol="-",
        description="Second/Minute/Hour/Day/Month/Year/Local minute offset/Localhour offset",
    )
    datetime3 = Unit(
        id=0x58,
        name="DateAndTime3",
        symbol="-",
        description="Second/Minute/Hour/Month/Day/Year",
    )
    datetime4 = Unit(
        id=0x59,
        name="DateAndTime4",
        symbol="-",
        description="Second/Minute/Hour/Month/Day/Year/Local minute offset/Localhour offset",
    )
