...
class SecuredDataTransmission(BaseService):
    ...
    class Code:
        ...
        TerminationWithSignatureRequested = (
            ResponseCode.TerminationWithSignatureRequested - 0x38
        )
        ...
        AuditTrailInformationNotAvailable = (
            ResponseCode.AuditTrailInformationNotAvailable - 0x38
        )
