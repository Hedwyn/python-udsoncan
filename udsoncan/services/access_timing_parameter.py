...
class AccessTimingParameter(BaseService):
    ...
    @classmethod
    def make_request(
        cls, access_type: int, timing_param_record: Optional[bytes] = None
    ) -> Request:
        """
        ...
        if (
            timing_param_record is not None
            and access_type != cls.AccessType.setTimingParametersToGivenValues
        ):
            raise ValueError(
